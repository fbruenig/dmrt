...
public:
    ...
    void executeFly(vector<vector<double> > *finalDmrts, vector<vector<int> > *finalCounts, vector<vector<int> > *finalUpts, vector<vector<vector<double> > > *finalDist, const vector<vector<double> > *vec, const double start, const double interval, const double end, const int dataColumn = 1);
    void executeFly(vector<vector<double> > *finalDmrts, vector<vector<int> > *finalCounts, vector<vector<int> > *finalUpts, vector<vector<vector<double> > > *finalDist, const vector<vector<double> > *vec, const vector<double> radii, const int dataColumn = 1);
